  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa] text-neutral-900 p-4 sm:p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {/* HEADER */}
        <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-neutral-200/80">
          <div className="space-y-1">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-brand-charcoal-dark tracking-tight">
              Controle de Estoque & Cargas
            </h1>
            <p className="text-xs sm:text-sm text-neutral-500">
              Sincronizado em tempo real no banco de dados.
            </p>
          </div>
        ...
        {/* CONTAINER COM ALTURA MÍNIMA PARA EVITAR CLS */}
        <div className="min-h-[420px]">
            ...
            <div className="space-y-6">
              {loading && balances.length === 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[1, 2, 3].map((n) => (
                    <div key={n} className="bg-white p-5 rounded-2xl border border-neutral-200/80 shadow-sm h-48 animate-pulse" />
                  ))}
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    return (
                      <div 
                        ...
                        className={`bg-white p-5 rounded-2xl border shadow-sm space-y-4 ${
                          isCritical ? 'border-amber-400 bg-amber-50/20' : 'border-neutral-200/80'
                        }`}
                      >
                        {isCritical && (
                        ...
                        <div>
                          <h2 className="font-bold text-brand-charcoal-dark text-base">{item.name}</h2>
              ...
              {/* HISTÓRICO DE CARGAS */}
              <section className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200/80 space-y-4">
                <div className="flex items-center justify-between">
                  <h2 className="font-bold text-brand-charcoal-dark text-base flex items-center gap-2">
          ...
          {activeTab === 'CAMINHAO' && (
            <form onSubmit={handleRegisterTruck} className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-neutral-200/80 space-y-6">
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label htmlFor="truck-supplier" className="block text-xs font-semibold text-neutral-600 mb-1">Fornecedor / Origem</label>
                  <input 
                    id="truck-supplier"
                    type="text" 
                    required 
                ...
                <div>
                  <label htmlFor="truck-tons" className="block text-xs font-semibold text-neutral-600 mb-1">Toneladas de Gesso em Pó (T)</label>
                  <input 
                    id="truck-tons"
                    type="number" 
                    step="0.5" 
                ...
                <div>
                  <label htmlFor="truck-plates" className="block text-xs font-semibold text-neutral-600 mb-1">Placas 60x60 no Caminhão (un)</label>
                  <input 
                    id="truck-plates"
                    type="number" 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-neutral-50 p-4 rounded-xl border border-neutral-200">
                <div>
                  <label htmlFor="truck-mat-cost" className="block text-xs font-bold text-neutral-700 mb-1">Material na Fábrica (R$)</label>
                  <input 
                    id="truck-mat-cost"
                    type="number" 
                    required 
                ...
                <div>
                  <label htmlFor="truck-freight-cost" className="block text-xs font-bold text-neutral-700 mb-1">Frete do Caminhão (R$)</label>
                  <input 
                    id="truck-freight-cost"
                    type="number" 
                    required 
                ...
                <div>
                  <label htmlFor="truck-labor-cost" className="block text-xs font-bold text-neutral-700 mb-1">Diária dos Chapas / Descarga (R$)</label>
                  <input 
                    id="truck-labor-cost"
                    type="number" 
                    required 
          ...
          {/* ABA 3: VENDA DE BALCÃO */}
          {activeTab === 'BALCAO' && (
            <form onSubmit={handleRegisterCounterSale} className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-neutral-200/80 space-y-6">
              <div>
                <h2 className="text-lg font-bold text-brand-charcoal-dark flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="sale-customer" className="block text-xs font-semibold text-neutral-600 mb-1">Nome do Cliente / Gesseiro</label>
                  <input 
                    id="sale-customer"
                    type="text" 
                ...
                <div>
                  <label htmlFor="sale-item" className="block text-xs font-semibold text-neutral-600 mb-1">Item Vendido</label>
                  <select 
                    id="sale-item"
                ...
                <div>
                  <label htmlFor="sale-qty" className="block text-xs font-semibold text-neutral-600 mb-1">
                ...
                <div>
                  <label htmlFor="sale-price" className="block text-xs font-semibold text-neutral-600 mb-1">Preço Unitário Cobrado (R$)</label>
                  <input 
                    id="sale-price"
                    type="number" 
                    step="0.05" 
