          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={monthlyFinancials} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="faturamento" name="Faturamento Total" stroke="#18181b" strokeWidth={2.5} fillOpacity={1} fill="url(#colorFaturamento)" />
                <Area type="monotone" dataKey="lucro" name="Lucro Total Estimado" stroke="#10b981" strokeWidth={2.5} fillOpacity={1} fill="url(#colorLucro)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="space-y-4">
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyFinancials} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                />
                <Legend verticalAlign="top" align="right" iconType="circle" wrapperStyle={{ fontSize: "11px", paddingBottom: "10px" }} />
                <Bar dataKey="faturamentoBalcao" name="Vendas Balcão (R$)" fill="#ef4444" radius={[6, 6, 0, 0]} barSize={22} />
                <Bar dataKey="lucroBalcao" name="Margem Balcão (R$)" fill="#f87171" radius={[6, 6, 0, 0]} barSize={22} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs">
            <div className="bg-rose-50/70 p-4 rounded-2xl border border-rose-200">
              <span className="text-rose-700 block font-bold">Total Arrecadado no Balcão</span>
            ...
            <div className="bg-neutral-50 p-4 rounded-2xl border border-neutral-200/80">
              <span className="text-neutral-500 block font-bold">Volume de Gesso Vendido Avulso</span>
              <span className="text-base font-black text-brand-charcoal-dark">
                {monthlyFinancials.reduce((a, b) => a + b.gessoBalcaoTon, 0).toFixed(1)} Toneladas
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={monthlyFinancials} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                />
                <Legend verticalAlign="top" align="right" iconType="circle" wrapperStyle={{ fontSize: "11px", paddingBottom: "10px" }} />
                <Area type="monotone" dataKey="faturamentoObras" name="Faturamento Obras" stroke="#10b981" strokeWidth={2.5} fillOpacity={1} fill="url(#colorObras)" />
                <Area type="monotone" dataKey="lucroObras" name="Lucro das Obras" stroke="#059669" strokeWidth={2} fillOpacity={0} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyFinancials} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                />
                <Legend verticalAlign="top" align="right" iconType="circle" wrapperStyle={{ fontSize: "11px", paddingBottom: "10px" }} />
                <Bar dataKey="gessoEntradaTon" name="Entrada Caminhão" fill="#3b82f6" radius={[6, 6, 0, 0]} barSize={16} />
                <Bar dataKey="gessoObrasTon" name="Consumo Obras" fill="#10b981" radius={[6, 6, 0, 0]} barSize={16} />
                <Bar dataKey="gessoBalcaoTon" name="Consumo Balcão" fill="#ef4444" radius={[6, 6, 0, 0]} barSize={16} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
